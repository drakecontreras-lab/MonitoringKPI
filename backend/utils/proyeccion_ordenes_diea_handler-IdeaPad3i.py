...
class ProyeccionOrdenesDieaHandler:
    ...
    async def ejecutar(self, grupo_planif: str = "CI0", layout: str = "/KPIAT0610_M", suffix: str = "_DIEA"):
self.log(f"[DIEA-DEDICADO] 📋 Iniciando Proyección IW37N DIEA...")
    ...
    async def exportar_fase_final(self) -> Optional[str]:
        ...
        try:
            ...
            temp_path = os.path.join(os.environ.get("_MONITORING_OUTPUT_DIR", os.path.join(os.getcwd(), "output")), f"tmp_diea_37n_{datetime.now().strftime('%H%M%S')}.xlsx")
